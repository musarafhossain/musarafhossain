...
import UnderConstructionImage from "../../assets/lottie/under_construction/UnderConstruction.json";
        ...
        <div className="container ">
          <div className="row under-construction-box  ">
            ...
            <div className="col-lg-3 col-10 ">
              <div
                className={`coming-soon-box ${theme ? "coming-soon-box-dark" : "coming-soon-box-light"
                  }`}
              >
                Coming Soon
              </div>
